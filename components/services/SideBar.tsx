...
const SideBar = () => {
    ...
    const setStampForSelectedPage = (servicePageName)=>{
        const stampClassProperties = ['workingSchdual','leaveRequest','showLeaveRequests']
    ...
    return (
        <div className="services-sidebar">
            <div className="services-sidebar_employee">
                ...
                <ul>
                <div className="listItem" onClick={()=>setStampForSelectedPage('workingSchdual')}>
                <div className={stampClass.workingSchdual}/>
                    <li>Working Schdual</li>
                </div>
                <div className="listItem" onClick={()=>setStampForSelectedPage('leaveRequest')}>
            ...
            <div className={managerSectionClass}>
                ...
                <div className="listItem" onClick={()=>setStampForSelectedPage('showLeaveRequests')} >
