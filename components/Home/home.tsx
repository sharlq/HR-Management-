        ...
        <CardAnimated yourClass={"home-cards_card"}>
          ...
          <Link href="/profile">
            <div className="imageContainer">
              <img
                className="image"
                src="https://drive.google.com/uc?export=view&id=1Sg3iRb5H-1-z1DrkfdOLKKy9pRnireMk"
                alt="profile picture"
              />
            </div>
          </Link>
        ...
        <CardAnimated yourClass={"home-cards_card"}>
          ...
          <Link href="/projects">
            <div className="imageContainer">
              <img
                className="image"
                src="https://drive.google.com/uc?export=view&id=1WFS4WssjhTGl75eIyHk4tOHKBAGW82ke"
                alt="profile picture"
              />
            </div>
          </Link>
        ...
        <CardAnimated yourClass={"home-cards_card"}>
          ...
          <Link href="/services">
            <div className="imageContainer">
              <img
                className="image"
                src="https://drive.google.com/uc?export=view&id=1YScnFEOkvnLJA0PTxQR_2ZAPOnLqQsEw"
                alt="profile picture"
              />
            </div>
          </Link>
